//скрипт по табличному или списочному выводу товара
...
$(document).ready(function(){
 ...
 //скрипт по развертыванию окна забыли пароль
 $(document).ready(function(){   
...
$('#prev-auth').click(function(){
 ...
 //Скрипт по выпаданию меню вход и по вводу логина и пароля
...
//скрипт по сравнению логина в меню вход с базой данных

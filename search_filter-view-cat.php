...
$new_querycat=$_SESSION['querycat'];
...
<?php
	...
	$result=mysqli_query($link, "SELECT * FROM `table-products` WHERE visible='1' $new_querycat $query_price ORDER BY products_id DESC");
